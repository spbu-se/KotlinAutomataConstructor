...
import automaton.constructor.model.MemoryUnit.Status.NOT_READY_TO_ACCEPT
...
class InputTape : AbstractTape {
    ...
    override val status get() = if (getChar(headPosition) == BLANK_CHAR) REQUIRES_TERMINATION else NOT_READY_TO_ACCEPT
